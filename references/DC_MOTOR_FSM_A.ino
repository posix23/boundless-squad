...
//GOAL::  To set up an FSM that can reverse the direction of a DC Motor based on a input button press. The FORWARD
//        direction occurs when the button is held down;  when the button isn't pressed, the REVERSE direction is 
//        activated.  To achieve this with minimal work, an H-BRIDGE ought to be used in circuit implementation. 
//        Follow the steps below.  Any pins may be used for this program, as long as they are digital.

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//MAKE SURE THAT YOU PUT A RESISTOR IN SERIES WITH AN LED, DO NOT CONNECT AN LED DIRECTLY TO A POWER SOURCE!!!!!!!!!!!!!!!!!///
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//YOU WILL NEED AN H-BRIDGE IN ORDER FOR THE CODE BELOW TO PERFORM AS ORGINALLY INTENDED.//////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

//Make sure the PIN numbers you assign here correspond correctly
int Dig_Pin1 = 1; //Pin Number for FORWARD Direction Here
int Dig_Pin2 = 2; //Pin Number for REVERSE Direction Here

int EnA_Pin = 4;  //Pin Number for H-Bridge Enable

int BUTTON_pin = 3; //Button Pin Number here

enum {FORWARD, REVERSE} present_state;
...
void setup() {
  ...
  pinMode(Dig_Pin1, OUTPUT); //Set INPUT or OUTPUT for Dig_Pin1 
  pinMode(Dig_Pin2, OUTPUT); //Set INPUT or OUTPUT for Dig_Pin2
  pinMode(EnA_Pin, OUTPUT); //Set INPUT or OUTPUT for EnA_Pin
  pinMode(BUTTON_pin, INPUT); // Set INPUT or OUTPUT for BUTTON_pin

  //        Initialize a digital value for OUTPUTS
  digitalWrite(Dig_Pin1, LOW); //First output
  digitalWrite(Dig_Pin2 , HIGH); //Second output

  digitalWrite(EnA_Pin, HIGH); //Enable Output
...
void loop() {
  ...
  switch(present_state){
    case FORWARD: //Turn on LED1 here

      digitalWrite(Dig_Pin1, HIGH);
      digitalWrite(Dig_Pin2, LOW);
      if(digitalRead(BUTTON_pin) == LOW){
        present_state = REVERSE;
      }
      break;
    case REVERSE: //Turn on LED2 here

      digitalWrite(Dig_Pin1, LOW);
      digitalWrite(Dig_Pin2, HIGH);
